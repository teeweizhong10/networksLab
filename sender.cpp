...
int main() {
    ...
    float MbpsWithErrors = ((((file_size + (numOfRetransmitedPackets*sizeOfPacket))/100000)/(totalElapsedTime.count()/1000))*8)/2;
    cout << "Throughput: " << MbpsWithErrors << " Mbps" << endl;

    float MbpsWithoutErrors = ((((file_size - (numOfRetransmitedPackets*sizeOfPacket))/100000)/(totalElapsedTime.count()/1000))*8)/2;
